      ...
      <div className="nav-container">
        ...
        <ul className="nav-links">
          <li className="nav-item">
            <span className="nav-link">Income Tax <span className="nav-arrow">▼</span></span>
          ...
          <li className="nav-item">
            <span className="nav-link">GST <span className="nav-arrow">▼</span></span>
            <div className="mega-menu liquid-glass-heavy">
              <div className="mega-col">
          ...
          <li className="nav-item">
            <span className="nav-link">Corporate <span className="nav-arrow">▼</span></span>
            <div className="mega-menu liquid-glass-heavy">
              <div className="mega-col">
          ...
          <li className="nav-item">
            <span className="nav-link">Other Services <span className="nav-arrow">▼</span></span>
        ...
        <div className="nav-actions" style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          <ThemeSelector />
          <a href="/portal" className="nav-cta liquid-glass" style={{ padding: '8px 16px', borderRadius: '8px', color: '#fff', fontWeight: 600, textDecoration: 'none' }}>
            🚀 Client Portal
          </a>
        </div>
      </div>
